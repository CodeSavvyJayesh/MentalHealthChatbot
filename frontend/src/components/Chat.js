...
function Chat({ chatId }) {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { text: data.reply || "No reply from server.", sender: "bot" },
      ])
    } catch (error) {
    ...
    <div className={`mindwell-chat-container ${darkMode ? "dark" : ""}`}>
      ...
      <div className="mindwell-chat-messages" ref={chatBoxRef}>
        {messages.map((msg, index) => (
          <div
            key={index}
            className={`mindwell-message-row ${msg.sender === "user" ? "user-row" : "assistant-row"}`}
          >
            <div className="mindwell-message-content">
              ...
              <div className="mindwell-message-text">
                <div className="mindwell-message-author">
            ...
            <div className="mindwell-message-content">
              <div className="mindwell-avatar">
                <div className="bot-avatar-circle typing-avatar">
                  <img src={mediverseLogo} alt="MindWell AI" className="mediverse-logo typing-logo" />
                </div>
              </div>
              <div className="mindwell-message-text">
